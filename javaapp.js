...
function displayForecast(response) {
  ...
  let forecastElement = document.querySelector("#prognoza");

  let forecastHTML = `<div class="rzad">`;
  prognoza.forEach(function (forecastDay, index) {
    if (index < 6) {
      forecastHTML =
        forecastHTML +
        `
